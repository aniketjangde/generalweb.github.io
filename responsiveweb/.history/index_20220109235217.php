...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="container">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btn btn-primary">Watch/Check Out</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-1">
                    <div class="container">
                        <div class="card">
                            <img class="card-img-top" src="image/wine.jpg" alt="Card image" style="width:100%">
                            <div class="card-body">
                                <h4 class="card-title">cakes</h4>
                ...
                <div class="col-lg-4 col-md-4 col-1">
                    <div class="container">
                        <div class="card">
                            <img class="card-img-top" src="image/cake3.jpg" alt="Card image" style="width:100%">
                            <div class="card-body">
                                <h4 class="card-title">cakes</h4>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12">
                    <img src="image/cake.jpg" alt="" class="img-fluid pb-2">
                </div>
                <div class="col-lg-4 col-md-4 col-12">
                    <img src="image/cake.jpg" alt="" class="img-fluid pb-2">
                </div>
    ...
    <footer>
        <p class="p-3 bg-dark text-white text-center">@AJCodes</p>
    </footer>
...
<!-- 
    ...
    w-50 = width 
    m-auto = margin auto 
    textarea = description dene ke liyae
