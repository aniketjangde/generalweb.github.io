        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-1">
                    <div class="container">
                        <div class="card">
                            <img class="card-img-top" src="image/pablo.jpg" alt="Card image" style="width:100%">
                            <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-1">
                    <div class="container">
                        <div class="card">
                            <img class="card-img-top" src="image/josephstalin.jpg" alt="Card image" style="width:100%">
                            <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 col-1">
                    <div class="container">
                        <div class="card">
                            <img class="card-img-top" src="image/elchapo.jpg" alt="Card image" style="width:100%">
                            <div class="card-body">
